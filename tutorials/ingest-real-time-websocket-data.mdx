...
import CreateHypertableStocks from '/snippets/tutorials/_create-hypertable-twelvedata-stocks.mdx';
import GraphOhlcv from '/snippets/tutorials/_graphing-ohlcv-data.mdx';
import { CLOUD_LONG, ACCOUNT_LONG, SERVICE_LONG } from '/snippets/vars.mdx';
...
[candlestick-tutorial]: /tutorials/financial-tick-data
[get-started]: /manage-data/get-started/get-started-with-timescaledb
...
[cloud-install]: /deploy-and-operate/tiger-cloud/get-started/get-started-with-tiger-cloud#create-your-tiger-cloud-account
