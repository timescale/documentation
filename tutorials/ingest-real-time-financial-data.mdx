...
import { CAGG, CLOUD_LONG, COMPANY, HYPERTABLE, PG, SERVICE_LONG, TIMESCALE_DB } from '/snippets/vars.mdx';
...
1.  **Query your data**: create {CAGG}s to aggregate OHLCV data, query the aggregated data, and visualize the data in Grafana.
