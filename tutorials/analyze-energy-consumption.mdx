...
sidebarTitle: Energy consumption
...
import { CAGG, CAGG_CAP, COLUMNSTORE, HYPERTABLE, SERVICE_LONG } from '/snippets/vars.mdx';
...
1. **Create the dashboard**
   ...
   1. In the `Queries` section, select `Code` on the right, then run the following query based on your {CAGG}:
