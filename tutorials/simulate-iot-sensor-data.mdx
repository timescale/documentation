...
sidebarTitle: Simulate IoT sensor data
...
[create-a-service]: /deploy-and-operate/tiger-cloud/get-started/create-services/#create-a-timescale-cloud-service
[connect-to-service]: /deploy-and-operate/tiger-cloud/get-started/run-queries-from-console
