...
description: Analyze transactions and discover insights about fees, mining revenue, and more
keywords: [intermediate, crypto, blockchain, Bitcoin, finance, analytics, hyperfunctions, continuous aggregates, time-series analysis]
---
...
import { CAGG, CAGG_CAP, CLOUD_LONG, PG, SERVICE_LONG, TIMESCALE_DB } from '/snippets/vars.mdx';
...
and load data into the tables using `psql`.

You then learn how to conduct analysis on your dataset using Timescale
hyperfunctions. It walks you through creating a series of {CAGG}s,
...
When you have your dataset loaded, you can create some {CAGG}s
...
queries. For this tutorial, you need three {CAGG}s focusing on
...
To find if more transactions in a block mean the block is more expensive to yours:
...
To find if higher block weight means the block is more expensive to yours:
...
[cloud-install]: /deploy-and-operate/tiger-cloud/get-started/get-started-with-tiger-cloud
