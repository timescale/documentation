...
<IntegrationPrereqs />
- Sign up for a [Grafana account][grafana-setup] to graph your queries (optional).
...
1.  To visualize this in Grafana (optional), create a new panel, select the
...
1.  To visualize this in Grafana (optional), create a new panel, select the
    Bitcoin dataset as your data source, and type the query from the previous
    step. In the `Format as` section, select `Time series`.
1.  To make this visualization more useful (optional), add an override to put
...
1.  To visualize this in Grafana (optional), create a new panel, select the
    Bitcoin dataset as your data source, and type the query from the previous
    step. In the `Format as` section, select `Time series`.
1.  To make this visualization more useful (optional), stack the series to
...
[grafana-setup]: /integrations/observability-alerting/grafana
