...
import ImportDataEnergy from '/snippets/tutorials/_import-energy-data.mdx';
...
[test-drive-enable-compression]: /manage-data/get-started/get-started-with-timescaledb#enhance-query-performance-for-analytics
[test-drive-tiered-storage]: /manage-data/get-started/get-started-with-timescaledb#slash-storage-charges
