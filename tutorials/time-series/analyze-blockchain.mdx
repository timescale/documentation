...
description: Use TimescaleDB hyperfunctions to analyze transactions on the Bitcoin blockchain and discover insights about fees, mining revenue, and more
...
import { CLOUD_LONG, ACCOUNT_LONG, SERVICE_LONG, TIMESCALE_DB, PG, CAGG, CAGG_CAP } from '/snippets/vars.mdx';
...
[docs-cagg]: /use-timescale/continuous-aggregates/
...
[grafana-setup]: /integrations/grafana/