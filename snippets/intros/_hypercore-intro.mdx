import { HYPERCORE_CAP, TIMESCALE_DB, HYPERTABLE, ROWSTORE, COLUMNSTORE, HYPERCORE, PG } from '/snippets/vars.mdx';
...
[chunk-skipping]: /manage-data/features/hypertables/improve-query-performance
