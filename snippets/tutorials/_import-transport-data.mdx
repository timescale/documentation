...
import { COLUMNSTORE, COMPANY, CONSOLE, DATA_MODE, HYPERCORE, HYPERTABLE, PG, ROWSTORE, SELF_LONG, SERVICE_LONG, SERVICE_SHORT } from '/snippets/vars.mdx';

<HypertableIntro />

1.  **Import time-series data into a {HYPERTABLE}**

    1. Unzip [nyc_data.tar.gz][nyc-data-targz] to a `<local folder>`.
...
[data-ingest]: /manage-data/data-management/import-and-ingest/import-terminal
