import { SERVICE_SHORT, COMPANY, CONSOLE, OPS_MODE, READ_REPLICA, COLUMNSTORE, DATA_MODE, ACCOUNT_LONG, CLOUD_LONG, SERVICE_LONG, TIMESCALE_DB, PG, HYPERCORE } from '/snippets/vars.mdx';
