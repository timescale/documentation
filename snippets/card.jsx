...
export const CardComponent = ({children, icon, title, href, cta}) => {
  return (
    <a href={href} className="group/item flex gap-3 flex-col pt-6 px-6 pb-9 rounded-2xl bg-white dark:bg-background-dark border border-gray-950/10 dark:border-white/10 overflow-hidden w-full cursor-pointer hover:!border-primary dark:hover:!border-primary-light">
