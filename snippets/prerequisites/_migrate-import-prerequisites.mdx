import { SERVICE_LONG, SERVICE_SHORT } from '/snippets/vars.mdx';
...
- Create a target [{SERVICE_LONG}][created-a-database-service-in-timescale].
  ...
  [most popular extensions][all-available-extensions]. {SERVICE_LONG}s do not support tablespaces,
...
[created-a-database-service-in-timescale]: /cloud/get-started/create-services
