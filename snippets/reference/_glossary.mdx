...
import { CLOUD_LONG, COMPANY, HYPERTABLE, CHUNK, CHUNK_CAP, CHUNK_SKIPPING_CAP, COLUMNSTORE_CAP, CAGG_CAP, HA_REPLICA_CAP, HYPERCORE_CAP, HYPERTABLE_CAP, IO_BOOST, PRICING_PLAN_CAP, PERFORMANCE, SCALE, ENTERPRISE, READ_REPLICA_CAP, ROWSTORE_CAP, SERVICE_LONG, SERVICE_SHORT, TIME_BUCKET_CAP, TIMESCALE_DB, PG, VPC } from '/snippets/vars.mdx';
