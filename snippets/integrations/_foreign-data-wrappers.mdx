...
import { PG, SERVICE_LONG, CLOUD_LONG, VPC, SERVICE_SHORT, SELF_LONG_CAP } from '/snippets/vars.mdx';
...
[vpc-peering]: /manage-data/timescaledb/data-management/security/vpc/
[sql-editor]: /get-started/timescaledb/run-queries-from-console/#ops-mode-sql-editor/
