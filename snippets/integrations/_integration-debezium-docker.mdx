import { PG, SELF_LONG } from '/snippets/vars.mdx';
...
4. **Register the Debezium {PG} source connector**
...
6. **Verify `timescaledb-connector` is running**
   ...
   2. Watch the events in the accounts topic on your {SELF_LONG} instance. 
