...
*   Create a [Python virtual environment](https://docs.python.org/3/library/venv.html). (Optional)
...
4.  Use the `psycopg2` [connect function](https://www.psycopg.org/docs/module.html?highlight=connect#psycopg2.connect) to create a new
