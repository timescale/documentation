...
1.  [Locate your {TIMESCALE_DB} credentials][connection-info] and compose a connection string as a
    [libpq connection string][libpq-connstring] in the following format:
