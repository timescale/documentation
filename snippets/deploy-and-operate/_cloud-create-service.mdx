import WhereNext from "/snippets/admonitions/_where-to-next.mdx";
import CloudIntro from "/snippets/intros/_cloud-intro.mdx";
import Install from "/snippets/deploy-and-operate/_cloud-installation.mdx";
import Connect from "/snippets/deploy-and-operate/_cloud-connect-service.mdx";
import ServiceOverview from "/snippets/intros/_service-overview.mdx";
import { ACCOUNT_LONG, CLOUD_LONG, CONSOLE, DATA_MODE, PG, PRICING_PLAN, SERVICE_LONG, SERVICE_SHORT, TIMESCALE_DB } from '/snippets/vars.mdx';
