...
export const MCP_LONG = 'Tiger MCP';
export const MCP_SHORT = 'Tiger MCP';
export const AGENTS_LONG = 'Tiger Agents for Work';
export const AGENTS_SHORT = 'Tiger Agent';
...
export const MST_CONSOLE_LONG = 'Managed Service for TimescaleDB Console';
...
export const CLOUD_EDITOR = 'Tiger Cloud SQL editor';
...
export const PGAI_LONG = 'pgai on Tiger Data';
...
export const MST_SERVICE_LONG = 'Managed Service for TimescaleDB service';
