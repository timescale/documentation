...
This file path is internally passed to [smart_open][smartopen], so it supports any protocol that smart_open supports, including:
...
[many-more]: https://github.com/piskvorky/smart_open/blob/master/help.txt
