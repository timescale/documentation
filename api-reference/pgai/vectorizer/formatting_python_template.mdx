...
|------|------|---------|----------|-------------|
| `template` | `TEXT` | `$chunk` | ✔ | A string using [Python template strings][python-template-strings] with $-prefixed variables that defines how the data should be formatted |
