---
title: ai.formatting_python_template
...
|------|------|---------|----------|-------------|
| `template` | `TEXT` | `$chunk` | ✔ | A string using [Python template strings](https://docs.python.org/3/library/string.html#template-strings) with $-prefixed variables that defines how the data should be formatted |
