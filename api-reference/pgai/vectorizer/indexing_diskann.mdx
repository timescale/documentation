...
| num_neighbors | int | - | ✖ | Advanced [DiskANN][diskann] parameter |
| search_list_size | int | - | ✖ | Advanced [DiskANN][diskann] parameter |
| max_alpha | float8 | - | ✖ | Advanced [DiskANN][diskann] parameter |
| num_dimensions | int | - | ✖ | Advanced [DiskANN][diskann] parameter |
| num_bits_per_dimension | int | - | ✖ | Advanced [DiskANN][diskann] parameter |
