...
1. **Enable {COLUMNSTORE} on a {HYPERTABLE}**
   ...
   - **{CAGG_CAP}s**:
    1. [Use `ALTER MATERIALIZED VIEW` for a {CAGG}][compression_continuous-aggregate]:
      ...
      1. Create a [columnstore_policy][add_columnstore_policy] that automatically converts {CHUNK}s in a {HYPERTABLE}
...
[hypercore]: /manage-data/data-management/hypercore/hypercore
