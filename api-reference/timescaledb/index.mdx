...
import { HYPERFUNC, HYPERTABLE_CAP, HYPERFUNC_CAP, TIMESCALE_DB } from '/snippets/vars.mdx';
...
{TIMESCALE_DB} provides SQL commands and functions for managing time-series data efficiently. For additional
{HYPERFUNC}s for advanced time-series analysis, see the [TimescaleDB Toolkit API reference][tookit-api-ref].

[tookit-api-ref]: /api-reference/timescaledb-toolkit/index
