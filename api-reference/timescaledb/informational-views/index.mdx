...
{TIMESCALE_DB} makes complex database features like partitioning and data retention easy to use with
our comprehensive APIs. {TIMESCALE_DB} works hard to provide detailed information about the state of
your data, {HYPERTABLE}s, {CHUNK}s, and any jobs or policies you have in place.

These informational views query {TIMESCALE_DB}'s internal catalog—system tables that store metadata
about your database objects, configurations, and jobs. When you create a {HYPERTABLE}, add a
retention policy, or schedule a job, {TIMESCALE_DB} registers this information in its catalog. The
