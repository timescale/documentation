...
<Icon icon="archive" iconType="duotone" /> Deprecated [v2.8.0][tsdb-2.8.0] <Icon icon="tag" iconType="duotone" /> Since [2.4.0][tsdb-2.4.0]
...
|-|-|-|
| `time_bucket_ng` | DATE, TIMESTAMP, or TIMESTAMPTZ | The bucket's start time. The return type matches the input `ts` type. |
...
[tsdb-2.4.0]: https://github.com/timescale/timescaledb/releases/tag/2.4.0
[tsdb-2.8.0]: https://github.com/timescale/timescaledb/releases/tag/2.8.0
