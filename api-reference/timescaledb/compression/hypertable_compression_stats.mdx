...
<Icon icon="archive" iconType="duotone" /> Old API since [{TIMESCALE_DB} v2.18.0](https://github.com/timescale/timescaledb/releases/tag/2.18.0). Superseded by [hypertable_columnstore_stats()][hypertable-columnstore-stats].
