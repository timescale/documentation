---
title: Compression overview (superseded by hypercore)
...
<Icon icon="archive" iconType="duotone" /> Old API [v2.18.0][tsdb-2.18.0]. Superseded by [Hypercore][hypercore].

Compression functionality is included in {HYPERCORE}.

Before you set up compression, you need to [configure the {HYPERTABLE} for compression][alter-table-compression] and then
...
[compression-docs]: /manage-data/capabilities/compression
