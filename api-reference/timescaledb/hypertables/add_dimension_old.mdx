...
import { CHUNK, HYPERTABLE, HYPERTABLE_CAP, TIMESCALE_DB } from '/snippets/vars.mdx';

<Icon icon="archive" iconType="duotone" /> Deprecated [v2.13.0][tsdb-2.13.0]. Use [add_dimension()][add-dimension]. <Icon icon="tag" iconType="duotone" /> Since [1.0.0][tsdb-1.0.0]
