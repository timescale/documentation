...
<Icon icon="flask" /> Early access <Icon icon="tag" iconType="duotone" /> Since [2.11.0][tsdb-2.11.0]
...
[tsdb-2.11.0]: https://github.com/timescale/timescaledb/releases/tag/2.11.0
