...
<Icon icon="tag" iconType="duotone" /> Since [1.0.0][tsdb-1.0.0]
...
[integral]: /api-reference/timescaledb-toolkit/time_weight/integral[tsdb-1.0.0]: https://github.com/timescale/timescaledb-toolkit/releases/tag/1.0.0
