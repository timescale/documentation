...
<Icon icon="tag" iconType="duotone" /> Since [1.14.0][tsdb-1.14.0]
...
[interpolated_integral]: /api-reference/timescaledb-toolkit/time_weight/interpolated_integral[tsdb-1.14.0]: https://github.com/timescale/timescaledb-toolkit/releases/tag/1.14.0
