...
<div className="px-12 py-8 space-y-4">
    ...
    <Card  icon="globe" href="/integrations/integrations">
    ...
    <Card  icon="globe" href="/tutorials/tutorials">
