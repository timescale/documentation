...
<div className="px-12 py-8 space-y-4">
    <Columns cols={2}>
        <Card title="Get started with Tiger Cloud" icon="rocket" href="cloud/get-started/get-started-with-tiger-cloud">
        ...
        <Card title="Get started with TimescaleDB" icon="play" href="open-source/timescaledb/get-started/get-started-with-timescaledb">
    ...
    <Card
        title="Hypertables"
        icon="pen-to-square"
        href="open-source/timescaledb/hypertables/understand-hypertables"
    >
    ...
    <Card
        ...
        href="open-source/timescaledb/hypercore/understand-hypercore"
    >
    ...
    <Card
        ...
        icon="squirrel"
        href="open-source/timescaledb/continuous_aggregates/understand-continuous-aggregates"
    >
