...
graph TB
    ...
    click B "/manage-data/features/continuous-aggregates/real-time-aggregates" "Learn about real-time aggregates"
    click D "/manage-data/features/continuous-aggregates/real-time-aggregates" "Learn about real-time aggregates"
```
