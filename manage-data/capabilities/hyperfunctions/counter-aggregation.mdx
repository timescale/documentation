...
1. **Create a counter aggregate and the delta accessor function**
...
1. **Use the [`time_bucket`][time_bucket] function to produce a series of deltas**
...
1. **Re-aggregate from the continuous aggregate into a larger bucket size**
