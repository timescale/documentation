...
When performing bulk inserts, [decompress][decompress-chunks] affected chunks first, as inserting data into compressed chunks is more computationally expensive.
...
You can [decompress individual chunks][decompress-individual], use a [range to filter chunks][decompress-by-time], or decompress [specific chunks][decompress-on-constraints] based on query filters.

The latest Tiger Cloud versions support direct backfill into compressed chunks. You might encounter [this limit error][troubleshooting-tuple-limit] when the decompression process exceeds timescaledb.max_tuples_decompressed_per_dml_transaction (100k by default) limit. The solution provided is to disable or increase the limit.
...
[decompress-chunks]: /manage-data/features/compression/decompress-chunks
[decompress-individual]: /manage-data/features/compression/decompress-chunks#decompress-individual-chunks
[decompress-by-time]: /manage-data/features/compression/decompress-chunks#decompress-chunks-by-time
[decompress-on-constraints]: /manage-data/features/compression/decompress-chunks#decompress-chunks-on-more-precise-constraints
[troubleshooting-tuple-limit]: /manage-data/troubleshooting/troubleshooting#tuple-decompression-limit-exceeded-by-operation
