...
import OldCreateHypertable from "/snippets/admonitions/_old-api-create-hypertable.mdx";
...
[install]: /manage-data/get-started/get-started-with-timescaledb
...
[api-create-hypertable]: /api-reference/timescaledb/hypertable/create_hypertable/
[api-create-hypertable-arguments]: /api-reference/timescaledb/hypertable/create_hypertable/#arguments
[timestamps-best-practice]: https://wiki.postgresql.org/wiki/Don't_Do_This#Don.27t_use_timestamp_.28without_time_zone.29
[hypertables-section]: /manage-data/data-management/hypertables
[hypercore]: /manage-data/data-management/hypercore/
[secondary-indexes]: /manage-data/data-management/hypercore/secondary-indexes/
