...
{HYPERTABLE_CAP}s are designed for real-time analytics, they are {PG} tables that automatically partition your data by
time. Typically, you partition {HYPERTABLE}s on columns that hold time values.
...
[hypertables-section]: /manage-data/features/hypertables/understand-hypertables
