...
import { HYPERTABLE, CAGG, TSDB } from '/snippets/vars.mdx';
...
aggregates are ENABLED by default; when you create a continuous aggregate, queries to that view include the
