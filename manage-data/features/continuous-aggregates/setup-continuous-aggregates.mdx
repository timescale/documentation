...
1. Bucket your data by `time` and calculate the delta between time buckets using the `lag` window
   function:
...
[about-caggs-joins]: /manage-data/features/continuous-aggregates/understand-continuous-aggregates#continuous-aggregates-with-joins
