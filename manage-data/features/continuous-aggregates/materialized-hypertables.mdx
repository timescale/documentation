...
1. Query `timescaledb_information.continuous_aggregates`:
...
1. Locate the name of the {HYPERTABLE} you want to adjust in the results of the query. The results look
   like this:
