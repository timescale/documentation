...
1. Create the view and declare the timezone:
...
1. Create a {HYPERTABLE} and define the integer-based time column and chunk time
   interval:
...
1. Create the {CAGG} for the `devices` table:
