...
[alter-schema]: /manage-data/features/optimize-your-schema/alter-update-table-schema
[constraints]: /manage-data/features/optimize-your-schema/ensure-data-integrity-with-constraints
[fdw]: /manage-data/features/optimize-your-schema/query-external-data-sources-with-fdw
[indexing]: /manage-data/features/optimize-your-schema/indexing
[json]: /manage-data/features/optimize-your-schema/handle-semi-structured-data-with-json
[manage-tablespaces]: /manage-data/features/optimize-your-schema/manage-tablespaces
[postgresql-timestamp]: https://wiki.postgresql.org/wiki/Don't_Do_This#Don.27t_use_timestamp_.28without_time_zone.29
[triggers]: /manage-data/features/optimize-your-schema/automate-tasks-with-triggers
