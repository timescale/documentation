...
<CardGroup cols={2}>
  <Card
    ...
    icon="download"
    href="/deploy-and-operate/timescaledb/install-and-update/install-self-hosted"
  >
  ...
  <Card
    ...
    icon="shield-check"
    href="/deploy-and-operate/timescaledb/manage-data-security/high-availability"
  >
  ...
  <Card
    title="Configuration"
    icon="sliders"
    href="/deploy-and-operate/timescaledb/configuration/configure-your-deployment"
  >
  ...
  <Card
    title="Troubleshoot"
    icon="wrench"
    href="/deploy-and-operate/timescaledb/troubleshooting/troubleshooting"
  >
  ...
  <Card
    title="Reference"
    icon="book"
    href="/deploy-and-operate/timescaledb/reference/timescaledb-editions"
  >
