...
<CardGroup cols={2}>
  ...
  <Card
    title="Understand"
    icon="lightbulb"
    href="/deploy-and-operate/tiger-cloud/understand/tiger-cloud-architecture"
  >
  ...
  <Card
    ...
    icon="shield-check"
    href="/deploy-and-operate/tiger-cloud/data-security/high-availability"
  >
  ...
  <Card
    ...
    icon="lock"
    href="/deploy-and-operate/tiger-cloud/secure-access/configure-role-based-access"
  >
  ...
  <Card
    title="Configuration"
    icon="sliders"
    href="/deploy-and-operate/tiger-cloud/configuration/tune-your-service"
  >
  ...
  <Card
    title="Troubleshoot"
    icon="wrench"
    href="/deploy-and-operate/tiger-cloud/troubleshooting/troubleshooting"
  >
  ...
  <Card
    title="Reference"
    icon="book"
    href="/deploy-and-operate/tiger-cloud/reference/tiger-cloud-regions"
  >
