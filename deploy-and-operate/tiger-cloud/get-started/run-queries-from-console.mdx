...
import { CLOUD_LONG, PG, SERVICE_SHORT, CONSOLE, DATA_MODE_CAP, POPSQL, SQL_ASSISTANT_SHORT, DATA_MODE, SQL_EDITOR, OPS_MODE, ACCOUNT_LONG, CONSOLE_LONG, PROJECT_LONG, PROJECT_SHORT, PRICING_PLAN, READ_REPLICA, SERVICE_LONG, COMPANY, VPC } from '/snippets/vars.mdx';
