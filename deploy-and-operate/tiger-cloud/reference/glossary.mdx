...
**Iceberg Tables**: an open table format for large analytical datasets that enables reliable data lake capability with ACID transactions.
...
**Service**: a managed database instance in {CLOUD_LONG} that provides Postgres functionality extended with {TIMESCALE_DB} capabilities.
