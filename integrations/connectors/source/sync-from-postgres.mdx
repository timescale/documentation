...
import { SERVICE_SHORT, PG, PG_CONNECTOR, HYPERTABLE, COLUMNSTORE, CAGG } from '/snippets/vars.mdx';
...
* Enable features such as {HYPERTABLE}s, {COLUMNSTORE}, and {CAGG}s on your logical replica.
