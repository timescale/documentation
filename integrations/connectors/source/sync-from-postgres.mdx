...
description: Sync updates to your primary Postgres database with your Tiger Cloud service in real time
---

import { HYPERTABLE, CONSOLE } from '/snippets/vars.mdx';
import LivesyncPrereqsCloud from '/snippets/integrations/_livesync-prereqs-cloud.mdx';
import LivesyncPrereqsTerminal from '/snippets/integrations/_livesync-prereqs-terminal.mdx';
