...
keywords: [S3, source connector, Amazon S3, CSV, Parquet, file sync, data ingestion, real-time sync, ETL, batch import]
---
...
<Icon icon="flask" /> Early access: this source S3 connector is not yet supported for production use. If you have
    ...
    - [IAM Role][aws-iam-role].
      ...
      - Configure the trust policy. Set the:
        ...
        - `ExternalID`: set to the [{PROJECT_SHORT} and {SERVICE_SHORT} ID](/integrations/find-connection-details#find-your-project-and-service-id) of the
           ...
           This is to avoid the [confused deputy problem][aws-confused-deputy].
      - Give the following access permissions:

        - `s3:GetObject`.
        - `s3:ListBucket`.

    - [Public anonymous user][aws-public-anonymous].
...
3. **Optimize the data to synchronize in hypertables**
   ...
   3. Choose the interval. This can be a minute, an hour, or use a [cron expression][cron-expression].
...
[aws-iam-role]: https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_create_for-user.html#roles-creatingrole-user-console
[aws-confused-deputy]: https://docs.aws.amazon.com/IAM/latest/UserGuide/confused-deputy.html
[aws-public-anonymous]: https://docs.aws.amazon.com/AmazonS3/latest/userguide/example-bucket-policies.html#example-bucket-policies-anonymous-user
