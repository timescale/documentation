---
title: Sync from S3
description: Continuously import CSV and Parquet files from S3 buckets into hypertables with automated polling, compression support, and real-time analytics.
