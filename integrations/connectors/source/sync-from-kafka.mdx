...
keywords: [stream, kafka, connect, connector]
---
...
import { CLOUD_LONG, CONSOLE_SHORT, SERVICE_SHORT } from '/snippets/vars.mdx';
...
Take the following steps to create a Kafka source connector in {CLOUD_LONG}.
