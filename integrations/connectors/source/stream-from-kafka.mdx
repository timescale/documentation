...
description: Stream data from Kafka into a Tiger Cloud service
---

import { SERVICE_SHORT, CONSOLE, PROJECT_SHORT } from '/snippets/vars.mdx';
import IntegrationPrereqsCloud from '/snippets/integrations/_integration-prereqs-cloud-only.mdx';
