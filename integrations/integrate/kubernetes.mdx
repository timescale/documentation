...
description: Deploy and scale TimescaleDB on Kubernetes clusters using Helm charts for container orchestration, automated backups, and high availability configurations.
keywords: [Kubernetes, K8s, container orchestration, deployment, scaling, cloud native, microservices, containerization, pods]
---
...
import { CLOUD_LONG, SERVICE_LONG, SELF_LONG_CAP, TIMESCALE_DB } from '/snippets/vars.mdx';
