...
description: Deploy serverless functions with AWS Lambda to process events and ingest time-series data into hypertables without provisioning or managing infrastructure.
