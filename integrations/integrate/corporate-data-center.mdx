...
description: Connect on-premise corporate data centers to Tiger Cloud services using AWS Transit Gateway for secure private network access and hybrid cloud integration.
...
- Establish connectivity between your on-premise infrastructure and AWS.

   See the [Centralize network connectivity using AWS Transit Gateway][aws-onprem].
