...
sidebarTitle: psql
description: Connect to Tiger Cloud services using psql command-line client to run interactive SQL queries, manage databases, and execute scripts from the terminal.
keywords: [psql, command line, terminal, PostgreSQL client, CLI, interactive shell, SQL queries, database connection]
---


import IntegrationPrereqs from '/snippets/prerequisites/_integration-prereqs.mdx';
import { PG, SERVICE_SHORT, COMPANY } from '/snippets/vars.mdx';

This page shows you how to use the [`psql`][psql-docs] command line tool to interact with your {SERVICE_LONG}.
...
[connect-database]: /integrations/psql/#connect-to-your-service
