...
description: Export telemetry metrics, logs, and performance data from Tiger Cloud services to Amazon CloudWatch for centralized monitoring, alerting, and dashboards.
...
You can export telemetry data from your {SERVICE_LONG}s with the real-time analytics capability enabled to [Amazon CloudWatch][cloudwatch]. The available metrics include CPU usage, RAM usage, and storage. This integration is available for [Scale and Enterprise][pricing-plan-features] pricing tiers.
