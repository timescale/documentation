...
description: Provision and manage Tiger Cloud services as infrastructure as code using Terraform provider for automated deployment and configuration management.
...
import { CLOUD_LONG, COMPANY, CONSOLE, VPC, PG, SELF_LONG_CAP } from '/snippets/vars.mdx';
...
2. **Configure the {COMPANY} Terraform provider**
