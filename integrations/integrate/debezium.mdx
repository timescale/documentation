...
[hypertables]: /manage-data/data-management/hypertables
[hypercore]: /manage-data/data-management/hypercore/
[caggs]: /manage-data/data-management/continuous-aggregates/
...
[connect]: /get-started/timescaledb/run-queries-from-console/
[kafka-install-configure]: /integrations/debezium#install-and-configure-apache-kafka
[debezium-configure-database]: /integrations/debezium##configure-your-database-to-work-with-debezium
[psql-connect]: /integrations/psql/#connect-to-your-service
