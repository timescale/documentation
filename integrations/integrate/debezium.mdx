...
description: Capture database changes from hypertables, continuous aggregates, and hypercore using Debezium CDC platform and stream events to Kafka topics.
