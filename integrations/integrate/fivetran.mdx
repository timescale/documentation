...
description: Synchronize data from 500+ sources to Tiger Cloud using Fivetran's managed ETL connectors for automated data ingestion into hypertables.
...
This page shows you how to inject data from data sources managed by [Fivetran][fivetran] into a {SERVICE_LONG}.
