...
description: Orchestrate data pipelines with Apache Airflow DAGs to automate ETL workflows, schedule tasks, and manage time-series data ingestion into hypertables.
...
Apache Airflow® is a platform created by the community to programmatically author, schedule, and monitor workflows. A [DAG (Directed Acyclic Graph)][airflow-dag] is the core concept of Airflow, collecting [Tasks][airflow-task] together,
