...
## Create a connection to your Tiger service
...
## Exchange data with your Tiger service
...
[create-a-table-in-timescale]: /manage-data/get-started/get-started-with-timescaledb#optimize-time-series-data-in-hypertables
...
[enable-timescaledb]: /deploy-and-operate/timescaledb/install/
