---
title: Integrate Tableau with Tiger Cloud
sidebarTitle: Tableau
description: Connect Tableau to Tiger Cloud as a Postgres data source to create interactive visualizations and analytics dashboards from your time-series data.
keywords: [Tableau, business intelligence, BI, data visualization, dashboards, analytics, data exploration, interactive reports]
---
