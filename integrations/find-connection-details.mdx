...
## Find your {PROJECT_SHORT} and {SERVICE_SHORT} ID
...
2. **Retrieve your {SERVICE_SHORT} ID**:
   ...
   ![Retrive the {SERVICE_SHORT} id in {CONSOLE}](https://assets.timescale.com/docs/images/tiger-on-azure/tiger-console-service-id.png)
