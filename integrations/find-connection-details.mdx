...
description: Locate hostname, port, username, password, and database name to connect to Tiger Cloud, self-hosted TimescaleDB, or MST services.
...
1. **Retrieve your {PROJECT_SHORT} ID**:
   ...
   ![Retrieve the {PROJECT_SHORT} ID in {CONSOLE}](https://assets.timescale.com/docs/images/tiger-on-azure/tiger-console-project-id.png)
...
1. **Open the settings for your {PROJECT_SHORT}**:
   ...
   In [{CONSOLE}][console-services], click your {PROJECT_SHORT} name in the upper left corner, then click `Project settings`.
